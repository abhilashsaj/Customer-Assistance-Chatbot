...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendMessage() {
        ...
        assistantservice.setUsernameAndPassword("apikey", "b4Vo1f_gHgEHJ33VH1NG0Zn2p4gXLmR6fdHQv1WvLJEH");

        //TODO: Uncomment this line if you want to use API KEY
        assistantservice.setApiKey("b4Vo1f_gHgEHJ33VH1NG0Zn2p4gXLmR6fdHQv1WvLJEH");

        //Set endpoint which is the URL. Default value: https://gateway.watsonplatform.net/assistant/api
        assistantservice.setEndPoint("https://api.au-syd.assistant.watson.cloud.ibm.com/instances/5487d2eb-6e50-48ed-b031-87cdd5a4e796");
        InputData input = new InputData.Builder(inputmessage).build();
        //WORKSPACES are now SKILLS
        MessageOptions options = new MessageOptions.Builder().workspaceId("0a213a28-53e2-4a4c-9cd9-0eac6dafc787").input(input).context(context).build();
